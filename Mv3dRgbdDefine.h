...
#define MV3D_RGBD_INT_DEVICE_TIMEOUT        "DeviceTimeout"         // 设备控制超时时间ms
...
{
	Mv3dRgbdStream_Undefined    = 0,
	Mv3dRgbdStream_Depth        = 1,                                // 深度图数据流 
	Mv3dRgbdStream_Color        = 2,                                // Color图数据流 
	Mv3dRgbdStream_Ir_Left      = 3,                                // 左目图数据流 
	Mv3dRgbdStream_Ir_Right     = 4,                                // 右目图数据流
	Mv3dRgbdStream_Imu          = 5,                                // IMU数据流
    Mv3dRgbdStream_LeftMono     = 6,                                // 左目泛光图数据流
    Mv3dRgbdStream_Mask         = 7,                                // 掩膜图数据流
    Mv3dRgbdStream_Mono         = 8,                                // Mono图数据流
    Mv3dRgbdStream_Phase        = 9,                                // 相位图数据流
    Mv3dRgbdStream_Rgbd         = 10                                // RGB-D图数据流
}Mv3dRgbdStreamType;
...
typedef struct _MV3D_RGBD_IMAGE_DATA_
{
    ...
    BOOL                        bIsRectified;                       // 是否校正
    Mv3dRgbdStreamType          enStreamType;                       // 流类型，用于区分图像(图像格式相同时)

    uint8_t                     nReserved[8];                       // 保留字节
